...
function Dailygrind() {
  return (
    <div className="d-flex justify-content-center align-items-center vh-100">
      ...
      <Card.Title></Card.Title>
        <Card.Body>
          <Card.Title className="text-center fw-bold fs-4" ><a href="https://xavionstar.github.io/Daily-Grind/">Daily Grind</a></Card.Title>
          <Card.Title></Card.Title>
          <Card.Text>
          ...
          <a className="btn btn-primary" href="https://github.com/Xavionstar/Daily-Grind" role="button">Visit the Repo!</a>
        </Card.Body>
      </Card>
    </div>
  );
