  ...
  return (
    <div className="d-flex justify-content-center align-items-center vh-100">
      ...
      <Card.Img variant="top" src={techScreenShot} />
        <Card.Body>
          <Card.Title class="text-center fw-bold fs-4" ><a href="https://rocky-mesa-12977.herokuapp.com/">Technically Speaking</a></Card.Title>
          ...
          <a class="btn btn-primary" href="https://github.com/Xavionstar/Technically-Speaking" role="button">Visit the Repo!</a>
        </Card.Body>
      </Card>
    </div>
  );
