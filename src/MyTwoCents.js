  ...
  return (
    <div className="d-flex justify-content-center align-items-center vh-100">
      ...
      <Card.Img variant="top" src={myTwoCents} />
        <Card.Body>
          <Card.Title class="text-center fw-bold fs-4" >My Two Cents</Card.Title>
          ...
          <a class="btn btn-primary" href="https://github.com/Xavionstar/My-Two-Cents" role="button">Visit the Repo!</a>
        </Card.Body>
      </Card>
    </div>
  );
