  ...
  return (
    <div className="d-flex justify-content-center align-items-center vh-100">
      ...
      <Card.Img variant="top" src={takeAHikePic} />
        <Card.Body>
          <Card.Title class="text-center fw-bold" >If you love hiking, you should: <a href="https://takeahike-bootcamp.herokuapp.com/">Take A Hike!</a> </Card.Title>
          ...
          <a class="btn btn-primary" href="https://github.com/Xavionstar/Take-A-Hike" role="button">Visit the Repo!</a>
        </Card.Body>
      </Card>
    </div>
  );
