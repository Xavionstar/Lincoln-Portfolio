  ...
  return (
    <div className="d-flex justify-content-center align-items-center vh-100">
      ...
      <Card.Img variant="top" src={foodlePic} />
        <Card.Body>
          <Card.Title className="text-center fw-bold fs-4" >Disrupt your Diet: <a href="https://xavionstar.github.io/Foodle/">Foodle!</a> </Card.Title>
          ...
          <a className="btn btn-primary" href="www.github.com/Xavionstar/Foodle" role="button">Visit the Repo!</a>
        </Card.Body>
      </Card>
    </div>
  );
